...
\rhead{Trabajo Práctico N.º 1 -- Grupo \grupo}
\cfoot{\thepage}
...
\begin{titlepage}
  ...
  \vspace{3cm}
  {\Huge\bfseries Trabajo Práctico N.º 1\par}
  \vspace{0.8cm}
...
Para cada $K$ entre 1 y 100 proyectamos ambos conjuntos, entrenamos una regresión logística nueva (la
...
\begin{table}[H]
  ...
  \begin{tabular}{lcccccccc}
    ...
    \midrule
    Varianza acumulada & 28.3\,\% & 38.4\,\% & 44.7\,\% & 54.0\,\% & 66.0\,\% & 75.5\,\% & 83.9\,\% & 88.7\,\% \\
    \emph{Accuracy}    & 0.596 & 0.803 & 0.829 & \textbf{0.857} & 0.808 & 0.825 & 0.829 & 0.831 \\
    \bottomrule
  \end{tabular}
\end{table}
...
solo 5 números por imagen el clasificador funciona mejor que con los 16384 píxeles. Para $K$ mayor a 20,
aproximadamente, la curva oscila entre 0.80 y 0.845 alrededor de la línea de base sin una tendencia de
mejora, por lo que agregar componentes de baja varianza no aporta información útil. Las oscilaciones entre
