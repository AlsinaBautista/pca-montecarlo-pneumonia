...
y a partir de $K\approx190$ queda por debajo de ella y desciende hasta 0.786 en $K=300$. Esta caída es
transitoria: las componentes de ese tramo explican poca varianza y, estimadas con solo 2428 imágenes,
son en gran parte ruido que la regresión ajusta sin ganar información sobre la clase (sobreajuste).
Al seguir agregando componentes, las nuevas tienen varianza tan chica que el modelo casi no las usa y
el \acc{} vuelve a subir: 0.808 con $K=500$, 0.816 con $K=1000$ y 0.823 con $K=2427$ (todas las
componentes). En ese último caso PCA es solo una rotación de los datos centrados y el clasificador
coincide, salvo 2 imágenes, con el de la imagen completa. Las oscilaciones entre
